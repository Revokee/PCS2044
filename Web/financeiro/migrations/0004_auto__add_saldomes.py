...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SaldoMes'
        db.create_table(u'financeiro_saldomes', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mes', self.gf('django.db.models.fields.DateField')(unique=True)),
            ('saldo', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
        ))
        db.send_create_signal(u'financeiro', ['SaldoMes'])


    def backwards(self, orm):
        # Deleting model 'SaldoMes'
        db.delete_table(u'financeiro_saldomes')
