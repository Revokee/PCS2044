...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Saida'
        db.create_table(u'financeiro_saida', (
            ...
            ('destino', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ...
        db.send_create_signal(u'financeiro', ['Saida'])


    def backwards(self, orm):
        # Deleting model 'Saida'
        db.delete_table(u'financeiro_saida')
