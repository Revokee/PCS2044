...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'financeiro_entrada', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('valor', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('data_audit', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('data_entrada', self.gf('django.db.models.fields.DateTimeField')()),
            ('origem', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('descricao', self.gf('django.db.models.fields.TextField')()),
            ('responsavel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ))
        db.send_create_signal(u'financeiro', ['Entrada'])


    def backwards(self, orm):
        # Deleting model 'Entrada'
        db.delete_table(u'financeiro_entrada')
